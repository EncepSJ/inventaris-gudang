...
<div class="container mt-5">
    <h2 class="mb-4 text-center">Manajemen Data Supplier</h2>
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($data)) {
                    echo "<tr>
                        ...
                        <td>{$row['kontak']}</td>
                        <td>
                            <a href='edit.php?id={$row['id_supplier']}' class='btn btn-sm btn-warning'>Edit</a>
                            <a href='delete.php?id={$row['id_supplier']}' class='btn btn-sm btn-danger' onclick=\"return confirm('Yakin ingin menghapus?')\">Delete</a>
                        </td>
                    </tr>";
                }
                ?>
